  ...
  return (
    <div className="fixed top-0 left-0 z-20 w-screen">
      <div className="navbar">
        <div className="navbar-start ml-4 gap-2">
          <Link href="/" className="flex gap-2 items-center">
            ...
            >
              ...
              >
                <path d="M13 21L13 26H9L9 21H13Z" fill="current" />
                <path
            ...
            <h1 className="text-2xl ml-1 cursor-pointer">Quizkampen</h1>
          </Link>
        </div>
        ...
        <div className="navbar-end">
          ...
          <div className="dropdown">
            <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
              ...
              <ul
                tabIndex={0}
                className="menu menu-md dropdown-content text-neutral bg-primary rounded-box fixed top-20 right-3"
              >
                <li>
                  <Link href="/highscores">Scoreboard</Link>
